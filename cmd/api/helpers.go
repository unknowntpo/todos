...
// readIDParam reads the "id" URL parameter from the current request context, then convert it to an
// integer and return it. If the operation isn't successful, return 0 and an error.
...
// envelope wraps the response into a json object.
